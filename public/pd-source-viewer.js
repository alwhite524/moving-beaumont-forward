(() => {
  ...
  const sources = {
    ...
    "peregrine-2026-agenda-package": { title: "August 4, 2026 City Council Agenda Package", description: "Official City agenda package containing the Peregrine platform record considered as Agenda Item G.14.", type: "Official agenda package · PDF", date: "August 4, 2026", url: "/pd-documents/peregrine-2026-agenda-package.pdf" },
